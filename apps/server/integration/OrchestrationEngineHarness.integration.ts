...
import * as CaamService from "../src/caam/CaamService.ts";
...
import { ClaudeImportReactor } from "../src/orchestration/Services/ClaudeImportReactor.ts";
...
export const makeOrchestrationIntegrationHarness = (
  ...
  Effect.gen(function* () {
    ...
    const providerCommandReactorLayer = ProviderCommandReactorLive.pipe(
      ...
      Layer.provideMerge(serverSettingsLayer),
      Layer.provideMerge(CaamService.layerNoop),
    );
    ...
    const orchestrationReactorLayer = OrchestrationReactorLive.pipe(
      ...
      Layer.provideMerge(
        Layer.succeed(ClaudeImportReactor, {
          start: () => Effect.void,
          drain: Effect.void,
        }),
      ),
